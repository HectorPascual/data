...
/* harmony import */ var _user_edit_user_edit_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./user-edit/user-edit.component */ "./src/app/user-edit/user-edit.component.ts");
...
var routes = [
    ...
    },
    {
        ...
        component: _user_detail_user_detail_component__WEBPACK_IMPORTED_MODULE_4__["UserDetailComponent"],
...
var RankingComponent = /** @class */ (function () {
    ...
    RankingComponent.prototype.updateTable = function () {
        var _this = this;
        this.api.getUsers()
...
// const URL = '/api/';
var URL = 'http://localhost:3000/dowork';
var UploadComponent = /** @class */ (function () {
    function UploadComponent(api) {
        ...
        this.uploader.onCompleteItem = function (item, response, status, headers) {
            ...
            console.log("Score : ", _this.response);
            var user = { name: _this.inputValue, id: 14, position: 3, best_score: _this.response, attempt_number: 5 };
            api.postUser(user).subscribe(function (res) {
                console.log("post to db done", res);
                _this.ranking = new _ranking_ranking_component__WEBPACK_IMPORTED_MODULE_3__["RankingComponent"](api);
                _this.ranking.updateTable();
            }, function (err) {
                console.log(err);
            });
        };
    }
    UploadComponent.prototype.onKey = function (event) {
...
module.exports = ".example-container {\n    display: flex;\n    flex-direction: column;\n    max-height: 500px;\n    min-width: 300px;\n    overflow: auto;\n  }\n  \n  .isbn-col {\n    flex: 0 0 100px !important;\n    white-space: unset !important;\n  }\n  \n  .button-row {\n    margin: 10px 0;\n  }\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = __webpack_require__(/*! /home/hector/Documents/HackUPC2018/MyApp/data/my-app/src/main.ts */"./src/main.ts");
